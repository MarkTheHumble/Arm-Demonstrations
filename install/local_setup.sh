...
_colcon_prefix_sh_COLCON_CURRENT_PREFIX="/home/morfinm3/arm/Arm-Demonstrations/install"
...
if [ -n "$COLCON_PYTHON_EXECUTABLE" ]; then
  ...
  _colcon_python_executable="/home/morfinm3/arm/Arm-Demonstrations/.pixi/envs/default/bin/python3.12"
